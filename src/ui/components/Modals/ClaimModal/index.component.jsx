        ...
        <ModalBody>
          <ModalBodyWrapper>
            <MadalBodyTitle>
              <MadalBodyTitleTextWrap>
                <ModalBodyTitleText>
                  Claim {amount} USDT [ID: {id}]
                </ModalBodyTitleText>
                <ModalBodyTitleTextNotMain>
                  Inviter: {compressAddress(inviterAddress)}
                </ModalBodyTitleTextNotMain>
                <ModalBodyTitleTextNotMain>
                  Referral: {compressAddress(referralAddress)}
                </ModalBodyTitleTextNotMain>
                <ModalBodyTitleTextNotMain>Date: {timeToLocaltime(time)}</ModalBodyTitleTextNotMain>
              </MadalBodyTitleTextWrap>
              {error !== '' ? (
                <ModalTitleError>
